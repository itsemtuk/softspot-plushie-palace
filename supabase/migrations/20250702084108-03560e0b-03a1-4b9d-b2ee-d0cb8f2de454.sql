-- Enhanced Trade Request and Marketplace Selling System (Fixed)

-- Drop the existing trade_requests table and recreate it properly
...
-- Enhanced trade requests table (recreated)
...
-- Enhanced messages table for trade integration (recreate to avoid conflicts)
...
-- Marketplace listings policies (drop existing to avoid conflicts)
