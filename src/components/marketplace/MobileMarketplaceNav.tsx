...
const categories = [
  { id: "all", name: "All Items", count: 217 },
  ...
  { id: "ocean", name: "Ocean Life", count: 33 }
];
      ...
      <Collapsible open={isBrandsOpen} onOpenChange={setIsBrandsOpen}>
        <div className="px-4 pb-2">
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              className="w-full justify-between h-10 text-left font-medium text-gray-900 dark:text-white"
            >
